...
const AboutHome = () => {
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#0f0a0a] via-[#1a1212] to-[#2a1e1e] text-white py-10 sm:py-20 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-12 xl:gap-16 relative">

                {/* LEFT IMAGE */}
                <div className="w-full lg:w-5/12 order-1 relative group transform hover:scale-[1.01] transition-all duration-500">
                    <div className="relative rounded-[4rem] overflow-hidden border-4 border-amber-900/30 hover:border-amber-600/40 transition duration-300 shadow-2xl shadow-black/50">
                        ...
                        <img
                            src={AboutImage}
                            alt="Restaurant"
                            className="w-full h-auto object-cover aspect-[3/4] rotate-1 hover:rotate-0 transition-all duration-500"
                        />

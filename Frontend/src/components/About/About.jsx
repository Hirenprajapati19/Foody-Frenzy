...
const About = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#1a120b] via-[#3c2a21] to-[#1a120b] text-amber-50 overflow-hidden relative">
            ...
            {/* Glow Overlay */}
            <div className="absolute inset-0 opacity-10 mix-blend-soft-light bg-white" />
            ...
            >
                <div className="max-w-4xl mx-auto">
                    <motion.h1 className='text5xl sm:text-6xl md:text-7xl font-bold mb-4 font-serif bg-clip-text text-transparent bg-gradient-to-r from-amber-500 to-yellow-600'>
                        Cullinary Express
                    </motion.h1>
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
                    {features.map((f, i) => {
                      ...
                      blur-lg opacity-50 group-hover:opacity-80 transition-opacity duration-500" />
                                ...
                                {/* Card */}
                                <div className="relative bg-[#3c2a21]/90 backdrop-blur-lg rounded-3xl 
                      overflow-hidden border border-amber-600/30 
            ...
            <section className="py-16 px-4 md:px-8 bg-gradient-to-br from-[#1a120b] to-[#3c2a21]/90">
               ...
               rounded-xl border-2 border-amber-600/30
                                        ...
                                        <motion.div
                                            ...
                                            animate={{
                                                background: [
                                                    ...
                                                    "linear-gradient(45deg, #3c2a21 0%, #1a120b 60%, #3c2a21 100%)",
                                                    "linear-gradient(45deg, #3c2a21 0%, #1a120b 50%, #3c2a21 100%)",
                                                ],
                                            }}
                                            transition={{
            ...
            <section className="py-16 px-4 md:px-8 relative">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        Meet Our
                        <span className="text-amber-500">Culinary Artists</span>
                    </motion.h2>

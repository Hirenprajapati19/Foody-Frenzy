  ...
  return (
    <div className='bg-gradient-to-b from-[#1a1212] to-[#2a1e1e] text-white py-16 px-4 font-[Poppins]'>
      <div className='max-w-7xl mx-auto'>
        ...
        before:absolute before:inset-0 before:bg-gradient-to-t before:opacity-20"
              >
                ...
                <div className='p-6 relative z-10'>
                  <h3 className='text-2xl font-bold mb-2 bg-gradient-to-r from-amber-300 to-amber-500 bg-clip-text text-transparent font-[]'>
                    {item.name}
                  </h3>
                  <p className=' text-gray-300 mb-6 text-sm leading-relaxed tracking-wide '>
                    {item.description}
                  </p>
                  <div className='flex  items-center justify-between gap-4'>
                    ...
                    {qty > 0 ? (
                      ...
                      <button onClick={() => addToCart(item, 1)} className={`${addButtonBase} ${addButtonHover} ${commonTransition}`}>

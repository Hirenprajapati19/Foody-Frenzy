            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-12">
                    ...
                    <div className='flex justify-center md:justify-end'>
                        <div className='space-y-4'>
                            <h3 className='text-xl font-semibold mb-4 border-l-4 border-amber-400 pl-3 font-mwrriweather italic text-amber-300'>
                                Social Connect
                            </h3>
                            <div className='flex space-x-4'>
                                {socialIcons.map(({ icon: Icon, link, color, label }, idx) => (
                                    <p target='_blank' href={link} key={idx}
                                        className='text-2xl bg-amber-400/10 p-3 rounded-full hover:bg-amber-400/20 hover:scale-110 transition-all duration-300 relative group' style={{ color }}>
                                        <Icon className='hover:scale-125 transition-transform' />
                                        <span className='absolute -bottom-8 left1/2 -translate-x-1/2 bg-amber-400 text-black px-2 py-1 rounded text-xs font-bold opacity-0 group-hover:opacity-100 transition-opacity'>
                                            {label}
                                        </span>
                                    </p>
                                ))}
                ...
                <div className="border-t border-amber-800 pt-8 mt-8 text-center">
                    ...
                    <div className="group inline-block">
                        <a
                            ...
                            target="_blank"
                            className="text-lg font-sacramento bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 bg-clip-text text-transparent hover:text-purple-300 transition-all duration-500"
                        >
